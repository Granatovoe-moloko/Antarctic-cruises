...
var headerButton = document.querySelector('.header-menu__button');
var headerLogoMobile = document.querySelector('.header__logo-image--mobile');
var anchors = document.querySelectorAll('.header-menu__link');
var regPhone = /[0-9\-()+\s+]$/;
...
var toggleMobileMenu = function toggleMobileMenu() {
  ...
  var closeMenuEscape = function closeMenuEscape(evt) {
    if (isEscapeKey(evt)) {
      closeMobileMenu();
    }
  };
  ...
  document.addEventListener('click', function (evt) {
    var withinHeaderMenu = evt.composedPath().includes(headerMenu);
...
toggleMobileMenu(); // плавный скролл
